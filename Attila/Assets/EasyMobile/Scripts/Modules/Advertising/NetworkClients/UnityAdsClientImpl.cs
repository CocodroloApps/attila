...
namespace EasyMobile
{
    ...
    public class UnityAdsClientImpl : AdClientImpl
    {
        ...
        /// </summary>
        public event Action<AdPlacement> ShowBannerAdCallback;

        /// <summary>
        /// Occurs when a banner ad is closed.
        /// </summary>
        public event Action<AdPlacement> HideBannerAdCallback;
        ...
        void InternalShowBannerAdCallback(AdPlacement placement)
        {
            if (ShowBannerAdCallback != null)
                ShowBannerAdCallback(placement);
        }

        void InternalHideBannerAdCallback(AdPlacement placement)
        {
            if (HideBannerAdCallback != null)
                HideBannerAdCallback(placement);
        }
